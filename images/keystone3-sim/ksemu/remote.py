...
El driver SDL de upstream (ui_simulator/lv_drivers/sdl) registra el mouse como dispositivo
de entrada de LVGL, asi que el mouse *es* la pantalla tactil. No hace falta ningun mock:
alcanza con mover el puntero y apretar el boton dentro de la ventana.
"""
import os
import subprocess

from ksemu import screen
...
def _xdotool(*args):
    try:
        ...
        print("ksemu: xdotool fallo:", error)
